...
?>
<html>
<body background="clgimg/t1.jpg" alink=white vlink=white link=white>
<a href="profile.php"><h1 align=left>BACK</h1></a>
...
<option value="credit">By Credit Card</option>
...
$cn=mysql_connect("localhost","root");
$db=mysql_select_db("toys",$cn);
$q="insert into anbook values('$u2','$pid1','$pnm1','$pr1','$qty1','$un1','$co1','$em1','$add1','$ct1','$qt1','$py1')";
mysql_query($q);
mysql_close($cn);
